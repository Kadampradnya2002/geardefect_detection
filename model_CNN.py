...
path1 = 'E:/project/gear defect image processing/train'    #path of folder of images    
path2 = 'E:/project/gear defect image processing/training_set'  #path of folder to save images    
